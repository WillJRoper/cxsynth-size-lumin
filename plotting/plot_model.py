...
class COLIBRELOSStellarEmission(EmissionModel):
    """
    The stellar emission model used for in FLARES.
    ...
    def __init__(self, grid):
        ...
        young_attenuated_carbon = StellarEmissionModel(
            grid=grid,
            label="young_attenuated_carbon",
            apply_dust_to=young_attenuated_nebular,
            tau_v="tau_v",
            dust_curve=PowerLaw(slope=-1),
            mask_attr="ages",
        ...
        old_attenuated_carbon = StellarEmissionModel(
            grid=grid,
            label="old_attenuated_carbon",
            apply_dust_to=old_transmitted,
            tau_v="tau_v",
            dust_curve=PowerLaw(slope=-1),
            mask_attr="ages",
        ...
        young_attenuated_silicon = StellarEmissionModel(
            grid=grid,
            label="young_attenuated_silicon",
            apply_dust_to=young_attenuated_carbon,
            tau_v="tau_v",
            dust_curve=PowerLaw(slope=-1),
            mask_attr="ages",
            mask_op="<=",
        ...
        old_attenuated_silicon = StellarEmissionModel(
            grid=grid,
            label="old_attenuated_silicon",
            apply_dust_to=old_attenuated_carbon,
            tau_v="tau_v",
            dust_curve=PowerLaw(slope=-1),
            mask_attr="ages",
            mask_op=">",
        ...
        EmissionModel.__init__(
            ...
            grid=grid,
            label="stellar_total",
            combine=[young_attenuated_silicon, old_attenuated_silicon],
            related_models=[
                nebular,
                transmitted,
                reprocessed,
...
def get_colibre_emission_model(
    grid_name,
    grid_dir,
    fesc=0.0,
    fesc_ly_alpha=1.0,
    ...
    model = COLIBRELOSStellarEmission(grid)
...
if __name__ == "__main__":
    ...
    # Get the COLIBRE emission model
    colibre_model = get_colibre_emission_model(
        grid_name="test_grid.hdf5",
        grid_dir="../../../flares_test/",
        fesc=0.0,
        fesc_ly_alpha=1.0,
    ...
    fig, ax = colibre_model.plot_emission_tree()
    fig.savefig("../plots/colibre_emission_tree.png", dpi=300, bbox_inches="tight")
